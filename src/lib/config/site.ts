export const siteConfig = {
  ...
  description:
    "Premium custom laser engraving and handcrafted artistry in South Africa. Signature gifts, signage, wall art, and one-of-a-kind pieces — Elevate, Inspire & Redefine.",
